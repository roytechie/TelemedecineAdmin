...
@Component({
  selector: 'app-pahrmacy-report',
  templateUrl: './pahrmacy-report.component.html',
  styleUrls: ['./pahrmacy-report.component.scss']
})
export class PahrmacyReportComponent implements OnInit {
  displayedColumns: string[] = ['id', 'firstName', 'lastName', 'dob', 'phone', 'weight', 'dateSeen', 'state', 'assignedTo', 'status', 'pharmacyName'];
  ...
  getPatientsList() {
    ...
    this.reportRequest.endDate =this.adminService.returnFormatedDate(this.startDate);
    ...
    //this.reportRequest.reportType = 'Pharmacy'; 
    //this.reportRequest.reportType = 'PrescribedReport'; 
